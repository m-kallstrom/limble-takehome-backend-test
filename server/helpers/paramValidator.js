export const validateQueryParams = async(workerIds, locationIds, includedTasks) => {
  const errors = [];
  ...
  if (!validTaskType(includedTasks)) {
    errors.push("includedTasks must have a value of 'complete' or 'incomplete'")
  };
...
function validTaskType(param) {
  return param === "complete" || param === "incomplete" || typeof param == 'undefined';
};
